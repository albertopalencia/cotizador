<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."',referencia='".$referencia."', detalle='".$detalle."', precio_producto='".$precio_venta."' WHERE id_producto='".$id_producto."'";
