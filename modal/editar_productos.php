			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_referencia" name="mod_referencia" placeholder="Referencia del producto" required>
				</div>
			  </div>
			   <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="mod_detalle" name="mod_detalle" placeholder="Detalle del producto" required maxlength="255" ></textarea>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_precio" name="mod_precio" placeholder="Precio de venta del producto" required pattern="^[0-9]+([,][0-9]+)?$" title="Ingresa sólo números decimales" maxlength="8">
				</div>
			  </div>
